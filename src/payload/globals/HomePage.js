  ...
  fields: [
    {
      ...
      tabs: [
        ...
        label: "Hero",
          fields: [
            { name: "heroTopline", label: "Topline (top-left badge)", type: "text", defaultValue: "Integrated growth since 2021" },
            { name: "heroEyebrowNum", label: "Eyebrow number", type: "text", defaultValue: "(01)" },
            { name: "heroEyebrowText", label: "Eyebrow text", type: "text", defaultValue: "Media · Brand · Tech — unified" },
            {
              type: "row",
              fields: [
                { name: "headlinePrefix", label: "Headline · before accent", type: "text", defaultValue: "We engineer", admin: { width: "33%", description: "Text BEFORE the italic accent word." } },
                { name: "headlineAccent", label: "Italic accent word", type: "text", defaultValue: "growth", admin: { width: "33%", description: "Rendered with the brand highlight." } },
                { name: "headlineSuffix", label: "Headline · after accent", type: "text", defaultValue: "that compounds across four continents.", admin: { width: "34%", description: "Text AFTER the italic accent word." } },
              ],
            },
            {
              name: "heroBlurb",
              ...
              admin: { description: "Paragraph beneath the headline." },
            },
            {
              name: "heroStats",
              label: "Stats (3)",
              ...
              fields: [
                { name: "num", label: "Number", type: "text", required: true },
