...
// Five of these cards reuse vertical reel videos already on Cloudinary
// (uploaded for the home page showreel marquee) — we always check Cloudinary
// first before introducing a new asset, per docs/cloudinary-media-pipeline.md.
const CAPS = [
  { icon: "◆", title: "Creative Suite — Performance Ads", body: "The weekly 100-creative engine that powers our paid media. Iteration speed, locked craft.", chips: ["Static", "Motion", "UGC-style"], image: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?auto=format&fit=crop&w=1000&q=80", videoPublicId: "epigroww-global-website/home/reels/wk-14-performance-reel" },
  { icon: "▣", title: "Creative Suite — Marketplaces", body: "A+ pages, brand stores, catalog imagery, video modules — tuned to convert on page, not dashboards.", chips: ["Amazon", "Flipkart", "Shopify"], image: "https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=1000&q=80", videoPublicId: "epigroww-global-website/home/reels/wk-15-shopify-launch" },
  ...
  { icon: "●", title: "User Generated Ads", body: "Scripted, produced, and edited UGC — the format that beats your best static ad, every quarter.", chips: ["Scripted UGC", "Reviews", "Unboxing"], image: "https://images.unsplash.com/photo-1516684732162-798a0062be99?auto=format&fit=crop&w=1000&q=80", videoPublicId: "epigroww-global-website/home/reels/wk-16-ugc-reel-fnb" },
  { icon: "▲", title: "Social Media Marketing", body: "Always-on content, community, reactive creative — built for the feed, not the deck.", chips: ["Always-on", "Community", "Reactive"], image: "https://images.unsplash.com/photo-1611605698323-b1e99cfd37ea?auto=format&fit=crop&w=1000&q=80", videoPublicId: "epigroww-global-website/home/reels/wk-12-social-reel-beauty" },
  ...
  { icon: "✧", title: "Celebrity Endorsements", body: "Curation, contracting, creative direction — celebrity partnerships that earn their fee.", chips: ["Celebrity", "Athletes", "Regional"], image: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&w=1000&q=80", videoPublicId: "epigroww-global-website/home/reels/wk-13-influencer-d2c" },
